//HintName: ReadonlyResult.g.cs
// <auto-generated/>
#pragma warning disable
#nullable enable
namespace MyApp
{
    partial struct ReadonlyResult
    {
        ...
        public ReadonlyResult(global::MyApp.Success Success)
        {
            System.ArgumentNullException.ThrowIfNull(Success);
            _Success = Success;
        }

        public static implicit operator ReadonlyResult(global::MyApp.Success Success) => new ReadonlyResult(Success);
        public static explicit operator global::MyApp.Success(ReadonlyResult value) => value.AsSuccess;
        ...
        public ReadonlyResult(global::MyApp.Error Error)
        {
            System.ArgumentNullException.ThrowIfNull(Error);
            _Error = Error;
        }

        public static implicit operator ReadonlyResult(global::MyApp.Error Error) => new ReadonlyResult(Error);
        public static explicit operator global::MyApp.Error(ReadonlyResult value) => value.AsError;
