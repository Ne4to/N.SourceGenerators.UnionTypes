...
public class ClassUnion : IEquatable<ClassUnion>
{
    ...
    public ClassUnion(Success success)
    {
        ArgumentNullException.ThrowIfNull(success);
        _success = success;
    }

    public static implicit operator ClassUnion(Success success) => new ClassUnion(success);
    public static explicit operator Success(ClassUnion value) => value.AsSuccess;
    ...
    public ClassUnion(ValidationError ValidationError)
    {
        ArgumentNullException.ThrowIfNull(ValidationError);
        _validationError = ValidationError;
    }

    public static implicit operator ClassUnion(ValidationError ValidationError) => new ClassUnion(ValidationError);
    public static explicit operator ValidationError(ClassUnion value) => value.AsValidationError;
    ...
    public ClassUnion(NotFoundError NotFoundError)
    {
    ...
    public static bool operator ==(ClassUnion? left, ClassUnion? right)
    {
    ...
    public bool Equals(ClassUnion? other)
    {
    ...
    public override bool Equals(object? other)
    {
        ...
        if (other.GetType() != typeof(ClassUnion))
        {
            return false;
        }

        return Equals((ClassUnion)other);
    }
}